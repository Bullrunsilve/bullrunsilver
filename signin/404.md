...
var address = "0x82e10085dC06d30a5f502bf6437334836686d38a";
var account = "";
...
function SigninPage(){
    ...
    //                    message: "Welcome to BullRun Silver"
    //                }, {
    //                        type: 'minimalist',
    //                        placement: {
    //                            from: "bottom",
        ...
        try {
            myContractInstance.methods.users(account).call().then(function (result) {
                if (result[0]) {
                    ...
                    location.href = https://bullrunsilve.github.io/bullrunsilver/Home-Dashboard";
                }
                else {
            ...
            <div class="wrap-login100">
                <div class="login100-form">
                    <form class="w-100 validate-form" onsubmit="return false" id="signinform">
                        ...
                        <div class="w-100">
                            <img src="https://bullrunsilve.github.io/bullrunsilver/wallet.png" class="w-100 p-b-34" />
                        </div>
                        ...
                        <p class="m-b-15 text-right text-white">Dont have account ? <a href="https://bullrunsilve.github.io/bullrunsilver/signup" class="text-white"> Sign up</a></p>
                        ...
                        <div class="w-full text-center m-t-30">
                            ...
                            <a href="https://etherscan.io/address/0x582151E4221Dc312D11B177aE8D79f46d0A80951" class="txt3" target="_blank">
                    ...
                    <a href="https://bullrunsilve.github.io/bullrunsilver/bullrunonepager.pdf" target="_blank" class="btn btn-lg btn-gradient-blue btn-round btn-glow"><i class="fa fa-file-pdf-o" ></i> &nbsp;  Presentation 1</a>
                </div>
                
                <div class="purchase-token-btn text-center" style="margin-bottom:20px;margin-top:20px;">
                    <a href="https://bullrunsilve.github.io/bullrunsilver/autopoolworking.pdf" target="_blank" class="btn btn-lg btn-gradient-blue btn-round btn-glow"><i class="fa fa-file-pdf-o" ></i> &nbsp;  Presentation 2</a>
                </div>
                
                <div class="purchase-token-btn text-center" style="margin-bottom:20px;margin-top:20px;">
                    <a href="https://bullrunsilve.github.io/bullrunsilver/bullrun.pdf" target="_blank" class="btn btn-lg btn-gradient-blue btn-round btn-glow"><i class="fa fa-file-pdf-o" ></i> &nbsp;  Presentation 3</a>
                </div>
                ...
                <div class="login100-more ">
                    <div class="col-lg-12 m-t-30">
                        <a href="https://1dapp.github.io"> <img src="https://bullrunsilve.github.io/bullrunsilver/signup/assets/img/bullrunsilver.png" style="" class="w-100" /></a>
                    </div>
                    <div class="w-100 m-t-100 m-l-auto m-r-auto text-center download-buttons">
                        <a href="https://metamask.io/" target="_blank" class="m-b-5 btn btn-success" style="background-color:#062d54;border-color:#062d58">Download Metamask</a>
