...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="assets/img/bullrunsilver.png">
...
function SigninPage(){
    ...
    //                $.notify({
    //                    icon: 'https://bullrunsilve.github.io/bullrunsilver/signup/assets/img/bullrunsilver.png',
            ...
            <div class="wrap-login100">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 text-center d-flex d-block m-t-10">
                        <div class="row">
                            ...
                            <div class="socialjs col-lg-12 m-t-10">
                                ...
                                <a class="sharebutton telegram btn" target="_blank" style="background-color:#0088cc;color:white" href="https://t.me/BullRunSilver"><i class="fa fa-telegram"></i> </a>
                ...
                <div class="login100-more ">
                    <div class="col-lg-12 m-t-30">
                        <a href="/">  <img src="https://bullrunsilve.github.io/bullrunsilver/signup/assets/img/bullrunsilver.png" style="" class="w-100" /></a>
                    </div>
                    <div class="w-100 m-t-100 m-l-auto m-r-auto text-center download-buttons">
                        <a href="https://metamask.io/" target="_blank" class="m-b-5 btn btn-success" style="background-color:#068d28;border-color:#064d54">Download Metamask</a>
